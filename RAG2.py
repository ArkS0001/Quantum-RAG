...
num_qubits = math.ceil(math.log2(num_docs))  # Should be 5 for 20 documents.
...
# Determine the number of Grover iterations (approximation for one marked item).
...
# Use backend.run() as execute() is not available in your version.
